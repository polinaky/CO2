...
Lai uzstādītu programmu, izpildiet šos soļus:

1. **Instalējiet Python** (ja tas vēl nav izdarīts) no oficiālās vietnes.
2. **Instalējiet Flask bibliotēku**, izmantojot termināli: 
   ```bash
   pip install flask
3. **Lejupielādējiet projektu vai klonējiet to no GitHub**:
    git clone [https://github.com/polinaky/CO2.git](https://github.com/polinaky/CO2.git)
...
**1. Datu apskate**  <br>
    Izvēlieties datumu kalendārā  <br>
    Nospiediet pogu "Dati"  <br>
    Sarakstā tiks parādīti visi mērījumi izvēlētajā dienā  <br>
**2. Grafika skatīšana**  <br>
    Nospiediet pogu "Grafiks"  <br>
    Tiks parādīta diagramma, kas vizualizē CO₂ līmeņa izmaiņas
...
**Ievade:**
Lietotājs kalendārā izvēlas datumu 03/21/2026 un nospiež pogu "Rādīt".

**Sagaidāmā izvade:**
CO₂: 700 ppm – Labs
(Zemāk redzams saraksts ar konkrētās dienas stundām un mērījumiem)
